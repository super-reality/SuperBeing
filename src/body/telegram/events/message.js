...
import { addMessageToHistory, exitConversation, isInConversation, moreThanOneInConversation, prevMessage, prevMessageTimers, sentMessage } from "../chatHistory.js"
...
export async function onMessage(bot, msg, botName, username_regex) {
    ...
    Spine.getInstance.sendMessage(content.replace("!ping", ""), msg.message_id + '', 'Telegram', msg.chat.id + '', utcStr, addPing, _sender, addPing ? '[ \''+ msg.from.id + '\', \'' + msg.from.first_name + '\' ]' : 'none')
}